...
public class AdminStatisticsBookCirculationResource {
    ...
    public Response adminStatisticsBookCirculation(@HeaderParam("Database-Type") String databaseType) {
        ...
        if (databaseType.equalsIgnoreCase(DatabaseTypeEnum.SQL.toString())) {
            ...
            return adminStatisticsBookCirculationMongoDB();
        }
    }

    private Response adminStatisticsBookCirculationMongoDB() {
