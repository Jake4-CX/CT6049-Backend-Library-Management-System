...
@Path("/users/me/loans/all/between")
public class GetAllUserBooksLoansBetweenDateResource {

    @GET
    @RestrictedRoles({User.Role.USER, User.Role.ADMIN})
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAllUserBookLoansBetweenDate(@HeaderParam("Database-Type") String databaseType, @Context ContainerRequestContext requestContext, @QueryParam("startDate") String startDate, @QueryParam("endDate") String endDate) {
        ...
        try {
            ...
            if (databaseType.equalsIgnoreCase(DatabaseTypeEnum.SQL.toString())) {
                return getAllUserBookLoansBetweenDateSQL(userId, startDateDate, endDateDate);
            } else {
                return getAllUserBookLoansBetweenDateMongoDB(userId, startDateDate, endDateDate);
            }
    ...
    public Response getAllUserBookLoansBetweenDateMongoDB(String userId, Date startDate, Date endDate) {
        ...
        List<LoanedBook> loanedBooks = loanedBookService.findLoanedBooksForUserBetweenDate(user, startDate, endDate);
    ...
    public Response getAllUserBookLoansBetweenDateSQL(String userId, Date startDate, Date endDate) {
        Map<String, Object> response = new HashMap<>();
        ...
        HashMap<String, Object>[] loanedBooks = loanedBookService.getLoanedBooksForUserBetweenDate(Integer.valueOf(userId), startDate, endDate);
